      ...
      <div>
        <nav className="relative border-gray-600 h-{15vh} z-40 bg-gray-900 ">
          <div className="flex flex-wrap h-[15vh]  justify-between items-center self-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            <Link href={"/"} className="flex items-center">
              <span className="self-center text-4xl font-semibold whitespace-nowrap text-white">
                <span className="text-green-500">WE</span>kreta
              </span>
            </Link>
            <button
          ...
          <div
            ...
            className={
              menuPricing
                ? "mt-1 shadow-sm  bg-gray-900 absolute top-[95px] w-full "
                : "hidden"
            }
          ...
          >
            <div className="grid py-5 px-4 mx-auto max-w-screen-xl  text-white sm:grid-cols-2 md:grid-cols-3 md:px-6">
              <div>
                <Link href={"/vendorpricing"} className="block p-3 rounded-lg  hover:bg-gray-700">
                  <div className="font-semibold">Are you a Vendor?</div>
                  <span className="text-sm font-light  text-gray-400">
                    Check out our range of pricing for vendors.
                  </span>
                </Link>
              </div>
             {/* <div>
              ...
              <div>
                <Link href={"/customerpricing"} className="block p-3 rounded-lg  hover:bg-gray-700">
                  <div className="font-semibold">Are you a Consumer?</div>
                  <span className="text-sm font-light  text-gray-400">
                    Check out our range of pricing for consumers.
                  </span>
                </Link>
              </div>
            </div>
